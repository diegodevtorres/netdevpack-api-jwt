...
namespace Login.Lib.i18n
{
    public class IdentityMessagePtBr : IdentityErrorDescriber
    {
        ...
        public override IdentityError UserAlreadyInRole(string role) { return new IdentityError { Code = nameof(UserAlreadyInRole), Description = $"O usuário já possui permissão '{role}'." }; }
